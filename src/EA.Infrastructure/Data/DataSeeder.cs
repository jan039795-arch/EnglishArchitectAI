...
public static class DataSeeder
{
    ...
    private static string B1L1() => C(
        "Present Perfect Continuous emphasizes duration and shows actions that started in the past and continue now. 'How long have you been doing this?' — Form: have/has + been + verb-ING. Essential for discussing ongoing activities, work, and habits that continue to the present moment. (Essential Grammar in Use Intermediate, Unit 1). Watch 'Essential Grammar in Use Unit 1' for duration emphasis and perfect continuous structures.",
    ...
    private static string B1L2() => C(
        "Present Perfect Continuous questions and negatives ask about duration and express what has NOT been happening. Form: have/has (not) + been + verb-ING. Use 'How long...?' questions to ask about ongoing activities and their duration. (Essential Grammar in Use Intermediate, Unit 2). Watch 'Essential Grammar in Use Unit 2' for interrogative and negative structures with perfect continuous.",
    ...
    private static string B1L3() => C(
        "Past Perfect (Pluperfect) shows which event happened FIRST when discussing two past events. Form: had + past participle. Crucial for storytelling, narrative, and clarifying sequence in complex past situations. Essential for B1+ level fluency. (Essential Grammar in Use Intermediate, Unit 3). Watch 'Essential Grammar in Use Unit 3' for past perfect sequencing and narrative structures.",
    ...
    private static string B1L4() => C(
        "Past Perfect Continuous shows how long an action had been happening before another event in the past. Form: had + been + verb-ING. Use for: expressing duration before a past event, background actions in narratives, and explaining ongoing past situations. (Essential Grammar in Use Intermediate, Unit 4). Watch 'Essential Grammar in Use Unit 4' for continuous duration in past narrative contexts.",
    ...
    private static string B1L5() => C(
        "Future Continuous describes actions that will be happening at a specific moment in the future. Form: will + be + verb-ING. Use for: actions in progress at a future time, events that won't be completed by a future deadline, and predictions about future activities. (Essential Grammar in Use Intermediate, Unit 5). Watch 'Essential Grammar in Use Unit 5' for future progressive and temporal expressions.",
    ...
    private static string B1L6() => C(
        "Future Perfect Continuous shows how long an action will have been happening before a specific future moment. Form: will + have + been + verb-ING. Use for: expressing duration before a future event, life milestones, and achievements by future dates. (Essential Grammar in Use Intermediate, Unit 6). Watch 'Essential Grammar in Use Unit 6' for complex future perfect structures and duration expressions.",
    ...
    private static string B1L7() => C(
        "Modals express ability in different times: CAN (present), COULD (past), BE ABLE TO (all tenses). CAN and COULD are most common for ability. 'I can swim', 'She could speak five languages as a child', 'I will be able to drive next year'. (Essential Grammar in Use Intermediate, Unit 7). Watch 'Essential Grammar in Use Unit 7' for modal verb ability across tenses.",
    ...
    private static string B1L8() => C(
        "SHOULD, MUST, HAVE TO express obligation and advice at different strengths. SHOULD = advice/recommendation. MUST/HAVE TO = obligation/necessity. 'You should study' (good idea), 'You must arrive on time' (obligation), 'I have to go now' (necessity). (Essential Grammar in Use Intermediate, Unit 8). Watch 'Essential Grammar in Use Unit 8' for obligation and advice modals.",
    ...
    private static string B1L9() => C(
        "First Conditional describes real, possible situations in the future: IF + Present Simple, WILL + base verb. 'If it rains tomorrow, I will stay home.' Second Conditional describes unlikely/imaginary situations: IF + Past Simple, WOULD + base verb. 'If I were rich, I would travel.' (Essential Grammar in Use Intermediate, Unit 9). Watch 'Essential Grammar in Use Unit 9' for real and hypothetical conditional structures.",
    ...
    private static string B1L10() => C(
        "Third Conditional describes impossible past situations: IF + Past Perfect, WOULD HAVE + past participle. 'If I had known, I would have helped.' WISH expresses regrets about unreal or impossible situations. 'I wish I had studied harder.' Both show hypothetical or regretful thoughts. (Essential Grammar in Use Intermediate, Unit 10). Watch 'Essential Grammar in Use Unit 10' for third conditional and wish expressions.",
    ...
    private static string B1L11() => C(
        "Passive Voice transforms active sentences: 'Someone stole my phone' → 'My phone was stolen.' Use passive when the agent is unknown, unimportant, or obvious. Present Passive: am/is/are + pp. Past Passive: was/were + pp. Essential for formal writing and news reporting. (Essential Grammar in Use Intermediate, Unit 11). Watch 'Essential Grammar in Use Unit 11' for passive voice structures and agent expression.",
    ...
    private static string B1L12() => C(
        "Reported Speech allows you to communicate what someone said indirectly. Rules: verb tenses shift (present → past), pronouns shift (I → he/she), and time words change (now → then). Direct: 'I am happy,' she said. Reported: She said she was happy. Essential for natural conversation about what others said. (Essential Grammar in Use Intermediate, Unit 12). Watch 'Essential Grammar in Use Unit 12' for reported speech backshift and indirect communication.",
    ...
    private static string B2L1() => C(
        "The passive voice shifts the focus from the person doing the action to the action itself. It is used when the agent is unknown, unimportant, or obvious. British Council and academic writing frequently use passive voice. (Essential Grammar in Use Intermediate, Unit 13). Watch 'Essential Grammar in Use Unit 13' for passive voice focus and agent expression.",
    ...
    private static string B2L2() => C(
        "Modals combine with passive voice to express obligation, recommendation, possibility, or permission without specifying who performs the action. This is essential for formal communication and professional writing. (Essential Grammar in Use Intermediate, Unit 14). Watch 'Essential Grammar in Use Unit 14' for modal passive structures in formal contexts.",
    ...
    private static string B2L3() => C(
        "Reported speech is used to report what someone said without quoting their exact words. Verb tenses 'shift back' (backshift), and pronouns and time expressions change. Essential for narrative writing and formal communication. (Essential Grammar in Use Intermediate, Unit 15). Watch 'Essential Grammar in Use Unit 15' for tense backshift in reported statements.",
    ...
    private static string B2L4() => C(
        "Reported questions do NOT use question word order (no inversion). They use statement order (subject + verb). Yes/No questions use 'if' or 'whether'; Wh- questions keep their question word. Critical for advanced communication. (Essential Grammar in Use Intermediate, Unit 16). Watch 'Essential Grammar in Use Unit 16' for reported questions and statement order.",
    ...
    private static string B2L5() => C(
        "'Wish' and 'if only' express regret about situations in the present or past, or aspirations for the future. These structures use past tenses for present/past wishes (not reflecting actual past) and 'would' for future. Essential for expressing unreal situations. (Essential Grammar in Use Intermediate, Unit 17). Watch 'Essential Grammar in Use Unit 17' for wish structures and unreal situations.",
    ...
    private static string B2L6() => C(
        "Cleft sentences reorganize information for emphasis by splitting a sentence into two parts. They focus on WHO did something ('It was X who...') or WHAT happened ('It was X that...'). Common in formal writing, journalism, and persuasive speech. (Essential Grammar in Use Intermediate, Unit 18). Watch 'Essential Grammar in Use Unit 18' for cleft sentences and emphasis structures.",
    ...
    private static string B2L7() => C(
        "Phrasal verbs (verb + particle combinations) are central to natural English. Advanced phrasal verbs convey complex meanings concisely. Understanding the particle (up, down, in, out, on, off, etc.) helps predict meaning. Essential for fluent, native-like English. (Essential Grammar in Use Intermediate, Unit 19). Watch 'Essential Grammar in Use Unit 19' for advanced phrasal verb meanings and particles.",
    ...
    private static string B2L8() => C(
        "Quantifiers and articles at B2 level require nuanced understanding. Use 'some' vs 'any', 'much' vs 'many' vs 'a lot of', and articles with generics. Mastering these structures prevents common intermediate errors and enables precise expression. (Essential Grammar in Use Intermediate, Unit 20). Watch 'Essential Grammar in Use Unit 20' for quantifiers and article usage.",
    ...
    private static string B2L9() => C(
        "Relative clauses add information about a noun, making sentences more sophisticated. Defining clauses (no commas) provide essential info; non-defining clauses (with commas) provide extra info. Mastering both creates complex, fluent English. (Essential Grammar in Use Unit 21)",
    ...
    private static string B2L10() => C(
        "Adjectives describe nouns; adverbs describe verbs, adjectives, or other adverbs. Many adverbs are formed by adding -ly to adjectives, but some are irregular. Correct placement and formation are essential for fluent English. (Essential Grammar in Use Unit 22)",
    ...
    private static string B2L11() => C(
        "Conjunctions connect clauses and sentences. Coordinating conjunctions (and, but, or) join equal clauses. Subordinating conjunctions (because, if, when) join a dependent clause to an independent clause. Mastering them creates smooth, logical writing. (Essential Grammar in Use Unit 23)",
    ...
    private static string B2L12() => C(
        "Prepositions express relationships of place, time, direction, and manner. Some prepositions combine with specific verbs (phrasal verbs), while others have multiple meanings depending on context. Understanding prepositions is essential for natural English. (Essential Grammar in Use Unit 24)",
    ...
    private static string B2L13() => C(
        "Advanced prepositions and multi-word prepositions (in spite of, on account of, by means of) add sophistication to writing. These structures are common in academic and formal English. Mastering them marks B2/C1 level proficiency. (Essential Grammar in Use Unit 25)",
    ...
    private static string B2L14() => C(
        "Phrasal verbs combine a verb with an adverb or preposition particle, creating meanings often impossible to guess from the individual words. Advanced phrasal verbs are essential for natural, native-like English across all registers. (Essential Grammar in Use Unit 26)",
    ...
    private static string B2L15() => C(
        "Collocations are word combinations that sound natural to native speakers. Understanding common collocations prevents errors like 'do a mistake' (correct: 'make a mistake'). Mastering collocations marks the difference between non-native and native-like English. (Essential Grammar in Use Unit 27)",
    ...
    private static string B2L16() => C(
        "Register and style involve choosing appropriate vocabulary, grammar, and tone for your audience and context. Formal English differs from casual English in verb choice, vocabulary, sentence complexity, and contraction use. Mastering register is key to sophisticated communication. (Essential Grammar in Use Unit 28)",
    ...
    private static string C1L1() => C(
        "Inversion places the auxiliary verb BEFORE the subject after certain negative or limiting adverbials. It creates strong emphasis and is a key feature of formal, literary, and sophisticated English. Perfect English Grammar emphasizes this advanced technique. (Advanced Grammar in Use, Unit 1 - Present Perfect Continuous)",
    ...
    private static string C1L2() => C(
        "Mixed conditionals combine different time frames. The most common type uses a past condition (3rd conditional) with a present result (2nd conditional), showing how a past event still affects the present. Essential for C1 proficiency. (Advanced Grammar in Use, Unit 2 - Present Perfect Continuous questions)",
    ...
    private static string C1L3() => C(
        "Academic and formal language uses precise vocabulary to convey complex ideas with nuance. At C1 level, you replace informal words with formal equivalents and use nominalizations for a sophisticated style. British Council and academic institutions emphasize this skill. (Advanced Grammar in Use, Unit 3 - Past Perfect)",
    ...
    private static string C1L4() => C(
        "Collocations are word partnerships that native speakers use naturally. Idioms are fixed expressions with meanings different from their literal words. Mastering both makes your English genuinely fluent and natural-sounding. (Advanced Grammar in Use, Unit 4 - Past Perfect Continuous)",
    ...
    private static string C1L5() => C(
        "Nominalization transforms verbs and adjectives into nouns, making language more formal and academic. 'He analyzed the data' becomes 'His analysis of the data...'. This technique is essential for sophisticated writing in English. (Advanced Grammar in Use, Unit 5 - Future Continuous)",
    ...
    private static string C1L6() => C(
        "Discourse markers (furthermore, nevertheless, meanwhile, notwithstanding) signal logical relationships between ideas. They guide the reader through your argument. Cohesion devices create smooth, professional English. Essential for C1 writing proficiency. (Advanced Grammar in Use, Unit 6 - Future Perfect Continuous)",
    ...
    private static string C1L7() => C(
        "Ellipsis (omitting words understood from context) and substitution (using pronouns or 'do') create natural, concise English. Native speakers use these constantly to avoid repetition. Essential for fluent, authentic English. (Advanced Grammar in Use, Unit 7 - Modal Deduction)",
    ...
    private static string C1L8() => C(
        "The subjunctive mood expresses wishes, recommendations, and unreal situations. In formal English, it appears in 'I suggest that he BE present' (not 'is'). Modal structures (could, might, may) express possibility, permission, and hypothetical situations with precision. (Advanced Grammar in Use, Unit 8 - Modal Deduction Continuous)",
    ...
    private static string C1L9() => C(
        "Reported speech (or indirect speech) conveys what someone said without quoting directly. At C1, you master reporting structures beyond simple 'said' — including tell, ask, wonder, admit, acknowledge, insist — and handle tense shifts and reported questions precisely. (Advanced Grammar in Use, Unit 9 - Had to and Could)",
    ...
    private static string C1L10() => C(
        "Advanced reported speech includes tense shifts (backshift), reported subjunctive, and reporting embedded clauses. Understanding backshift is crucial: 'He said he was tired' (at that moment) versus 'He said he is tired' (still tired now). (Advanced Grammar in Use, Unit 10 - Semi-modals)",
    ...
    private static string C1L11() => C(
        "Participle clauses (reduced relative clauses) make writing more concise and sophisticated. 'The student who was working on the project' becomes 'The student working on the project' — more elegant and more natural in academic and professional contexts. (Advanced Grammar in Use, Unit 11 - Causative Structures)",
    ...
    private static string C1L12() => C(
        "Advanced relative clause structures include whose + noun (possession), preposition + which (formal), and adverbial relative clauses (why, when, where, how). These structures add sophistication to complex, academic writing. (Advanced Grammar in Use, Unit 12 - Advanced Passive)",
    ...
    private static string C1L13() => C(
        "Gradable adjectives (hot, cold, good, bad) admit degrees (very hot, quite hot). Ungradable adjectives (perfect, complete, impossible, dead) do not — you cannot say 'very complete'. At C1, you distinguish these for precision and avoid elementary mistakes. (Advanced Grammar in Use, Unit 13 - Reporting Verbs)",
    ...
    private static string C1L14() => C(
        "Adverb placement affects meaning and elegance. Adverbs can appear sentence-initial (formally), mid-position (typically), or end-position (naturally). Comment adverbs (frankly, undoubtedly, fortunately) signal the speaker's attitude and add sophistication. (Advanced Grammar in Use, Unit 14 - Verb Patterns)",
    ...
    private static string C1L15() => C(
        "Complex prepositions (in front of, because of, in addition to, in accordance with, by virtue of) are more precise than simple prepositions. Mastering them elevates your formal writing and academic expression. (Advanced Grammar in Use, Unit 15 - Inverted Conditionals)",
    ...
    private static string C1L16() => C(
        "Inversion (placing the verb before the subject) and cleft sentences (using 'it is...that' or 'what...is') add emphasis and sophistication. These structures signal native proficiency in formal, academic, and literary English. (Advanced Grammar in Use, Unit 16 - Hypothetical Wish)",
    ...
    private static string C2L1() => C(
        "Non-defining relative clauses (set off by commas) provide extra information about a noun without restricting its meaning. They often use which, whose, and where, and are more common in formal, academic writing. Understanding their structure is essential for C2 sophistication. (Advanced Grammar in Use, Unit 17)",
    ...
    private static string C2L2() => C(
        "Sentential relative clauses use which to refer to an entire previous clause rather than a specific noun. Relative adverbs (where, when, why, how) add sophistication. These structures are hallmarks of academic and formal writing. (Advanced Grammar in Use, Unit 18)",
    ...
    private static string C2L3() => C(
        "Reduced relative clauses — participle clauses and adjectival phrases — replace full relative clauses with more concise, elegant structures. 'The student working diligently' replaces 'The student who is working diligently.' This is essential for sophisticated, professional writing. (Advanced Grammar in Use, Unit 19)",
    ...
    private static string C2L4() => C(
        "Cleft sentences emphasize specific elements using 'it is...that' (it-clefts) or 'what...is' (wh-clefts). They are powerful tools for shifting emphasis and creating sophisticated English. 'It is methodology that distinguishes this study' emphasizes 'methodology'. (Advanced Grammar in Use, Unit 20)",
    ...
    private static string C2L5() => C(
        "Nominalization transforms action (verbs/adjectives) into things (nouns) for formal, sophisticated style. 'The government decided to reform education' becomes 'The government's reform of education.' Nominalizations dominate academic and professional writing. (Advanced Grammar in Use, Unit 21)",
    ...
    private static string C2L6() => C(
        "Fronting — moving sentence elements to the front for emphasis or stylistic effect — is a hallmark of sophisticated writing. 'Remarkable were the results.' 'Particularly troubling is the trend.' Fronting shifts attention and creates rhetorical impact. (Advanced Grammar in Use, Unit 22)",
    ...
    private static string C2L7() => C(
        "Negative inversion (with Never, Hardly, Seldom) and degree inversion (with So, Such) create dramatic emphasis. 'Never have I seen such courage.' 'So striking were the results that...' These are hallmarks of formal, literary, and sophisticated English. (Advanced Grammar in Use, Unit 23)",
    ...
    private static string C2L8() => C(
        "Focus adverbs (even, only, just, still, already, so) change meaning based on position. 'Only she knows' vs. 'She only knows' — different emphasis. These subtleties mark native proficiency and are essential for nuanced communication. (Advanced Grammar in Use, Unit 24)",
    ...
    private static string C2L9() => C(
        "Complex noun phrases use extensive pre- and post-modification to build sophisticated, information-dense expressions. 'The government decision on education policy' vs. 'The government's education policy decision'— word order and modification create different formality and emphasis. (Advanced Grammar in Use, Unit 25)",
    ...
    private static string C2L10() => C(
        "Idiomatic prepositions appear in fixed expressions where meaning cannot be derived from individual words. 'At stake' (not 'in stake'), 'by means of' (not 'with means'), 'in accordance with' (not 'in agreement with'). These fixed collocations are essential for native-like fluency. (Advanced Grammar in Use, Unit 26)",
    ...
    private static string C2L11() => C(
        "Advanced phrasal verbs show complex patterns: transitive vs. intransitive, separable vs. inseparable, and multi-word particles. 'Turn down' (transitive) vs. 'run into' (transitive), vs. 'look out' (intransitive). Understanding these patterns is essential for advanced fluency. (Advanced Grammar in Use, Unit 27)",
    ...
    private static string C2L12() => C(
        "Collocations and idiomatic prepositional phrases are word partnerships that native speakers use naturally. 'Strong coffee' (not 'powerful coffee'), 'reach an agreement' (not 'arrive at an agreement'), 'come to a conclusion' (not 'come to a decision' when referring to deduction). These cannot be learned rule-by-rule. (Advanced Grammar in Use, Unit 28)",
    ...
    private static string C2L13() => C(
        "Discourse markers organize extended text and signal logical relationships. Additive markers (furthermore, moreover), contrastive (nevertheless, however), causal (consequently, therefore), sequential (subsequently, eventually). These guide readers through complex arguments and mark sophisticated writing. (Advanced Grammar in Use, Unit 29)",
    ...
    private static string C2L14() => C(
        "Cohesive devices — reference, substitution, conjunction, and ellipsis — tie sentences and ideas together. Understanding how to create and follow cohesion is crucial for reading and writing coherent, sophisticated texts. Cohesion is the glue that makes writing flow. (Advanced Grammar in Use, Unit 30)",
    ...
    private static string C2L15() => C(
        "Ellipsis — omitting words understood from context — creates natural, concise English. 'He went to Paris; she to Rome' (ellipsis of 'went'). 'Better late than never' (ellipsis of 'it is'). Ellipsis makes writing and speech more fluent and less repetitive. (Advanced Grammar in Use, Unit 31)",
    ...
    private static string C2L16() => C(
        "Substitution — using pronouns or auxiliary verbs to replace clauses — allows native speakers to speak elegantly without repetition. 'Do you like coffee?' 'Yes, I do.' / 'Is she coming?' 'I think so.' / 'Some agree; others don't.' This is fluency and sophistication. (Advanced Grammar in Use, Unit 32)",
